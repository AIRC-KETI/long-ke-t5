...
class DataTrainingArguments:
    ...
    hf_cache_dir: Optional[str] = field(
        default=None, metadata={"help": "The path to cache directory for huggingface datasets."}
    )
    hf_data_dir: Optional[str] = field(
        default=None, metadata={"help": "The path to data directory for huggingface datasets."}
    )
    unanswerable_text: Optional[str] = field(
        default="",
        metadata={"help": "A text sequence for unanswerable question. (default: '')"},
    )
...
def main():
    ...
    def preprocess_squad_batch(
        ...
        targets = [answer["text"][0] if len(answer["text"]) > 0 else data_args.unanswerable_text for answer in answers]
