...
from models.modeling_t5_based_model import T5EncoderForQuestionAnswering
from models.modeling_long_t5_based_model import LongT5EncoderForQuestionAnswering
from models.tokenization_var import T5TokenizerFastForQA

# register T5EncoderForQuestionAnswering to  AutoModelForQuestionAnswering
AutoModelForQuestionAnswering.register(T5Config, T5EncoderForQuestionAnswering)
AutoModelForQuestionAnswering.register(LongT5Config, LongT5EncoderForQuestionAnswering)
...
def main():
    ...
    # check it is t5 tokenizer or not
    if isinstance(tokenizer, (T5Tokenizer, T5TokenizerFast)):
        if args.tokenizer_name:
            tokenizer = T5TokenizerFastForQA.from_pretrained(args.tokenizer_name)
        elif args.model_name_or_path:
